        ...
        if count >= (len(which_challenge())):
            ...
            if index == 0:
                ...
                if([list_of_inputs[0]]*len(list_of_inputs) != list_of_inputs):
                    ...
                    print()
                    print(fore.RED + style.BOLD + "You didn't reach a consensus. " + green + "Please try again.") 
                    ...
                    if(card_values[value_of_same[0]] >= value()[count]):
                        ...
                        print()
                        print(fore.RED + style.BOLD + "You've failed the challenge! " + green +"Keep this up and your group won't survive for long!!!")
                        input(fore.GREEN_YELLOW + style.BOLD + "Press Enter to Continue...")
                        value_of_same.clear()
                        players_threw_clear()
                        clear_last(sum_of_inputs)
